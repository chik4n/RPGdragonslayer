...
const locations = [
    {
        ...
        background: "url('images/townsquare1.jpg')",
	...
	},
	{
		...
		background: "url('images/youlose.jpg')",
		text: "You died. "
	},
	{
		name: "win",
		"button text": ["REPLAY?", "REPLAY?", "Go to town square"],
		"button functions": [restart, restart, goTown],
		background: "url('images/6457268.jpg')",
...
function goFight() {
	...
	if (fighting === 2) {
        document.body.style.backgroundImage = "url('images/dragon1.jpg')";
    } else {
